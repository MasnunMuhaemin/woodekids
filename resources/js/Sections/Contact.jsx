    ...
    <section className="relative w-full min-h-[600px] bg-white overflow-hidden flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 flex items-center py-20 px-8 md:px-16 lg:px-24 bg-gray-50/50 relative">
        ...
        <div className="max-w-xl relative z-10 w-full">
          ...
          <h2 className="text-4xl md:text-6xl font-bold font-heading text-gray-900 leading-[1.1] mb-8">
          ...
          <div className="grid gap-10">
            ...
            <a 
              ...
              className="group flex items-center gap-6 p-2 rounded-[2rem] hover:bg-white hover:shadow-xl hover:shadow-primary/10 transition-all duration-500"
            >
              <div className="w-16 h-16 bg-primary rounded-[1.5rem] flex items-center justify-center text-white shadow-lg shadow-primary/30 transition-transform group-hover:rotate-12">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
              </div>
              <div>
                <h4 className="text-sm font-black text-gray-400 uppercase tracking-widest mb-1">WhatsApp Kami</h4>
                <p className="text-xl md:text-2xl font-bold text-gray-900 font-sans">+62 812 3456 7890</p>
              </div>
            </a>

            {/* Address */}
            <div className="flex items-center gap-6 p-2">
              <div className="w-16 h-16 bg-secondary rounded-[1.5rem] flex items-center justify-center text-white shadow-lg shadow-secondary/30">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                </svg>
              </div>
              <div>
                <h4 className="text-sm font-black text-gray-400 uppercase tracking-widest mb-1">Workshop</h4>
                <p className="text-lg font-bold text-gray-600 font-sans leading-snug">
            ...
            {/* Socials */}
            <div className="flex items-center gap-6 p-2">
              <div className="w-16 h-16 bg-accent rounded-[1.5rem] flex items-center justify-center text-gray-900 shadow-lg shadow-accent/30">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
